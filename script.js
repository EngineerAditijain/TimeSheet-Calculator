...
var arr1 = ['Monday','Tuesday', 'Wednsday','Thursday','Friday','Saturday','Sunday'];
function createForm(day) {
 ...
 form.innerHTML = `
  ...
  <th>  <input type="text" class="orange" placeholder = ${day} disabled /></th>
    <td>
...
(async () => {
  tableBodyTrs.forEach((tr) => {
    tr.appendChild(createForm(tr.dataset.day));
  });
})();
